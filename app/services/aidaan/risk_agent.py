    ...
    async def handle_message(
        ...
        if "sentiment" in lowered:
            return AidaanMessageResponse(
                reply="Market sentiment is currently BULLISH for major FX pairs but showing volatility in EM.",
                bullets=[
                    "Sentiment Score: 0.72",
                    "Dominant Trend: Upward",
        ...
        return AidaanMessageResponse(
            ...
            actions=[
                ActionItem(
                    kind="check_limits",
                    title="View My Limits",
                    payload={"user": "trader-001"},
